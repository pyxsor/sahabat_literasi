...
$moling_select = query("SELECT * FROM peminjaman, buku group by lokasi asc;");
...
if (isset($_GET["moling"])) {
    $lokasi = $_GET['moling'];
    $peminjaman_filter = query("SELECT * FROM peminjaman, buku WHERE peminjaman.id_buku = buku.id AND buku.lokasi = '$lokasi' ");
